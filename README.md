...
## Companion repo: Speed-to-Lead Engine

This repo builds the AI **call**. The companion repo builds everything **around** the call: the instant response and the full multi-channel follow-up cadence.
